...
Se il progetto si trova nella cartella `psicometria`, possiamo utilizzare la funzione `here()` del pacchetto **here** per indicare la posizione del file `05_environment.qmd` in modo relativo. Ecco un esempio:
...
```r
usethis::create_project("/Users/corrado/_repositories/psicometria")
```
