...
La visualizzazione grafica dei dati rappresenta il punto di partenza di ogni analisi quantitativa. Grazie a rappresentazioni grafiche adeguate, è possibile individuare importanti caratteristiche di una distribuzione, come la simmetria o l'asimmetria, nonché la presenza di una o più modalità. In seguito, per descrivere sinteticamente le principali caratteristiche dei dati, è possibile utilizzare specifici indici numerici. In questo capitolo verranno presentati i principali indicatori della statistica descrittiva.
:::
...
Gli indici di tendenza centrale sono valori sintetici che hanno lo scopo di sintetizzare un insieme di dati individuando un valore rappresentativo, tipico o centrale attorno al quale i dati tendono a distribuirsi. Consentono di cogliere in modo immediato le caratteristiche fondamentali di una distribuzione, offrendo una descrizione sintetica ed efficace senza dover esaminare ogni singolo dato. Grazie alla loro capacità di riassumere informazioni complesse in un unico valore, gli indici di tendenza centrale costituiscono uno strumento essenziale nell'analisi statistica, sia descrittiva che inferenziale. I principali indici sono:
...
La scelta dell'indice più appropriato non è mai neutra, ma dipende dalla natura dei dati e dalla domanda a cui si vuole rispondere. In presenza di valori anomali, ad esempio, la mediana fornisce una rappresentazione più fedele rispetto alla media, che risulterebbe invece distorta. Padroneggiare questi strumenti significa, quindi, non solo essere in grado di calcolare un numero, ma anche di interpretare correttamente la struttura sottostante ai dati.
...
Se un insieme di dati è composto esclusivamente da valori binari (0 o 1), allora la somma corrisponde al numero totale di unità presenti, mentre la media rappresenta la proporzione di unità sul totale.
